      ...
      {mode === 'choose' && (
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <button
            ...
            className="group rounded-xl border border-border bg-surface p-8 text-left transition-all hover:border-nexus-500/50 hover:shadow-lg hover:shadow-nexus-500/5"
          >
            ...
            <h3 className="mb-1 text-lg font-semibold text-foreground group-hover:text-nexus-500 transition-colors">
              Share a Resource
            </h3>
        ...
        <div className="space-y-6">
          ...
          {file && connectionState === 'idle' && (
            <button
              ...
              className="w-full rounded-lg bg-nexus-500 px-4 py-3 font-medium text-white transition-colors hover:bg-nexus-600"
            >
              Start Sharing
            </button>
          )}
